  ...
  describe('Cross', () => {
    ...
    it('should output a cross', () => {
      ...
      expect(symbol).to.deep.equal({
        ...
        opacity: 0.5,
        strokeDasharray: '10 10',
        d: 'M -22 15 L 42 15 M 10 47 L 10 -17',
  ...
  describe('n-polygon', () => {
    ...
    it('should output a n-polygon', () => {
      ...
      expect(symbol).to.deep.equal({
        ...
        opacity: 0.5,
        strokeDasharray: '10 10',
        d: 'M26.000000000000004 -12.712812921102035 L-5.999999999999993 -12.712812921102042 L-22 14.999999999999996 L-6.000000000000014 42.71281292110203 L26.000000000000004 42.712812921102035 L42 15.000000000000007 Z',
        collider: expectedCollider
      });
    });
    ...
    describe('Options', () => {
      it('sides', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          opacity: 0.5,
          strokeDasharray: '10 10',
          d: 'M19.88854381999832 -15.433808521444913 L-15.888543819998315 -3.809128073359144 L-15.888543819998318 33.80912807335913 L19.88854381999831 45.43380852144492 L42 15.000000000000007 Z',
          collider: expectedCollider
        });
      });
      ...
      it('startAngle', () => {
        ...
        expect(symbol).to.deep.equal({
          ...
          opacity: 0.5,
          strokeDasharray: '10 10',
          d: 'M1.7177905567193328 -15.909626441250186 L-20.909626441250182 6.7177905567193275 L-12.627416997969526 37.62741699796952 L18.28220944328065 45.90962644125019 L40.90962644125018 23.282209443280664 L32.627416997969526 -7.627416997969515 Z',
          collider: expectedCollider
        });
      });
    });
  ...
  describe('Saltire', () => {
    ...
    it('should output a saltire', () => {
      ...
      expect(symbol).to.deep.equal({
        ...
        opacity: 0.5,
        strokeDasharray: '10 10',
        d: 'M -21.21460183660255 -16.21460183660255 l 62.4292036732051 62.4292036732051 M -21.21460183660255 46.214601836602554 l 62.4292036732051 -62.4292036732051',
        collider: expectedCollider
      });
    });
  });
