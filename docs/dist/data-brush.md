...
```
<a name='brush.addRange' href='#brush.addRange'># </a>*brush*.**addRange**(key *:string*, range *:struct*)

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| key |  *string*  | An identifier that represents the data source of the range | No | No |
| range |  *struct*  | The range to add to this brush | No | No |
...
```
<a name='brush.addRanges' href='#brush.addRanges'># </a>*brush*.**addRanges**(items *:Array&lt;struct&gt;*)

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| items |  *Array&lt;struct&gt;*  | Items containing the ranges to remove | No | No |

No description

<a name='brush.removeRange' href='#brush.removeRange'># </a>*brush*.**removeRange**(key *:string*, range *:struct*)

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| key |  *string*  | An identifier that represents the data source of the range | No | No |
| range |  *struct*  | The range to remove from this brush | No | No |
...
<a name='brush.setRange' href='#brush.setRange'># </a>*brush*.**setRange**(key *:string*, range *:struct*)

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| key |  *string*  | An identifier that represents the data source of the range | No | No |
| range |  *struct*  | The range to set on this brush | No | No |
...
<a name='brush.toggleRange' href='#brush.toggleRange'># </a>*brush*.**toggleRange**(key *:string*, range *:struct*)

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| key |  *string*  | An identifier that represents the data source of the range | No | No |
| range |  *struct*  | The range to toggle in this brush | No | No |
...
```
<a name='brush.containsRange' href='#brush.containsRange'># </a>*brush*.**containsRange**(key *:string*, range *:struct*) *:boolean*

|Name(s)|Type(s)|Description|Optional|Default value|
|-------|-------|-----------|--------|-------------|
| key |  *string*  | An identifier that represents the data source of the value | No | No |
| range |  *struct*  | The range to check for | No | No |
| Returns |  *boolean*  | No | ... | ... |
